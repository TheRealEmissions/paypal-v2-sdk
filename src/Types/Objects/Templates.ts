...
export class Templates extends Utility implements Static<IUtility, typeof Templates> {
  private addresses?: AddressPortable[];
  private phones?: PhoneDetail[];
  private templates?: Template[];
  private links?: LinkDescription[];
  private emails?: string[];

  public setAddresses(...addresses: AddressPortable[]): this;
  public setAddresses(...addresses: ((address: AddressPortable) => void)[]): this;
  public setAddresses(...addresses: (AddressPortable | ((address: AddressPortable) => void))[]) {
    this.addresses = addresses.map((address) => {
      if (address instanceof AddressPortable) return address;
  ...
  public static fromObject(obj: TTemplates) {
    ...
    if (obj.addresses) templates.setAddresses(...obj.addresses.map((address) => AddressPortable.fromObject(address)));
