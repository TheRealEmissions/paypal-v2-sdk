export enum Carrier {
  ...
  CA_OTHER = "CA_OTHER",
  DE_DEUTSCHE_POST_DHL_TRACK_TRACE_EXPRESS = "DE_DEUTSCHE_POST_DHL_TRACK_TRACE_EXPRESS",
  ...
  CA_DHL_GLOBAL_FORWARDING = "CA_DHL_GLOBAL_FORWARDING",
